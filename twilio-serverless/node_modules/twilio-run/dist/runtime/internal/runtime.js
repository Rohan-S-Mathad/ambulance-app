...
const debug = (0, logger_1.getDebugFunction)('twilio-run:runtime');
...
function getAssets() {
    ...
    for (const asset of assets) {
        if (asset.access === 'private') {
            ...
            const open = () => (0, fs_1.readFileSync)(asset.filePath, 'utf8');
...
function create({ env }) {
    function getSync(options) {
        ...
        const client = (0, twilio_1.default)(env.ACCOUNT_SID, env.AUTH_TOKEN, options);
        const service = client.sync.v1.services(serviceName || 'default');
