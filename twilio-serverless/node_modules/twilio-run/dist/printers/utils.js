...
exports.redactPartOfString = exports.errorMessage = exports.warningMessage = exports.importantMessage = exports.borderLeft = exports.terminalLink = exports.printObjectWithoutHeaders = exports.getTwilioConsoleDeploymentUrl = exports.supportsEmoji = exports.shouldPrettyPrint = exports.windowSize = void 0;
...
function getTwilioConsoleDeploymentUrl(serviceSid, environmentSid, region = 'us1') {
...
function printObjectWithoutHeaders(obj) {
    return (0, columnify_1.default)(obj, { showHeaders: false });
}
exports.printObjectWithoutHeaders = printObjectWithoutHeaders;
function terminalLink(name, link) {
    return (0, chalk_1.default) `${name} {dim | ${link}}`;
}
exports.terminalLink = terminalLink;
function borderLeft(text, color) {
    return text
        .split('\n')
        .map((str) => `${chalk_1.default.keyword(color)('│')} ${str}`)
        .join('\n');
}
exports.borderLeft = borderLeft;
const wrapText = (text) => (0, wrap_ansi_1.default)(text, exports.windowSize.width - 5, { trim: false });
