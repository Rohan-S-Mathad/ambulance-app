...
async function getEnvironment(cli, baseDir) {
    ...
    if (await (0, fs_2.fileExists)(fullEnvPath)) {
        try {
...
async function getConfigFromCli(flags, cliInfo = { options: {} }, externalCliOptions) {
    ...
    cli.cwd = baseDir;
    const pkgJson = await (0, utils_1.readPackageJsonContent)(cli);
