...
exports.mergeFlagsAndConfig = void 0;
...
function mergeFlagsAndConfig(config, flags, cliInfo) {
    const mergedResult = Object.keys(flags).reduce((result, key) => {
        let value = flags[key];
        const opt = cliInfo.options[(0, lodash_kebabcase_1.default)(key)];
        const arg = cliInfo.argsDefaults && cliInfo.argsDefaults[(0, lodash_kebabcase_1.default)(key)];
