...
async function getConfigFromFlags(flags, externalCliOptions) {
    ...
    const configFlags = (0, global_1.readSpecializedConfig)(cwd, flags.config, 'env', {
    ...
    const serviceSid = flags.serviceSid ||
        (await (0, utils_1.getFunctionServiceSid)(cwd, flags.config, 'env', ((_a = flags.username) === null || _a === void 0 ? void 0 : _a.startsWith('AC'))
            ? flags.username
