...
class Logger {
    ...
    warn(msg, title = '') {
        msg = (0, utils_1.warningMessage)(title, msg);
        this.log(msg, exports.LoggingLevel.warn);
    }
    error(msg, title = '') {
        msg = (0, utils_1.errorMessage)(title, msg);
...
function getDebugFunction(namespace) {
    const debugLogger = (0, debug_1.default)(namespace);
...
function logApiError(logger, err) {
    ...
    if (typeof moreInfoLink === 'string') {
        const linkText = (0, terminal_link_1.default)(moreInfoLink, moreInfoLink, {
...
function getOraSpinner(options) {
    ...
    return (0, ora_1.default)(oraOptions);
}
