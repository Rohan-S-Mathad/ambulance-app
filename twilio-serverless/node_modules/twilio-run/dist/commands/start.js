...
async function handler(argv, externalCliOptions) {
    (0, logger_1.setLogLevelByName)(argv.logLevel);
    (0, nodejs_version_1.default)();
    await (0, legacy_config_1.default)(argv.cwd, false);
    const config = await (0, start_1.getConfigFromCli)(argv, exports.cliInfo, externalCliOptions);
    ...
    await (0, project_structure_1.default)(config.baseDir, command, false, directories);
    ...
    const app = await (0, server_1.createLocalDevelopmentServer)(config.port, config);
    let server;
    ...
    return new Promise((resolve, reject) => {
        ...
        const serverStartedSuccessfully = (port) => {
            return async () => {
                ...
                try {
                    config.url = await (0, start_1.getUrl)(argv, config.port);
