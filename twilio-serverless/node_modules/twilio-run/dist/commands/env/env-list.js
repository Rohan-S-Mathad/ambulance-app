...
const env_list_1 = require("../../config/env/env-list");
const flags_1 = require("../../flags");
const env_list_2 = require("../../printers/env/env-list");
...
async function handler(flags, externalCliOptions) {
    ...
    let config;
    try {
        config = await (0, env_list_1.getConfigFromFlags)(flags, externalCliOptions);
    }
    catch (err) {
        debug(err);
        logger_1.logger.error(err.message);
    ...
    try {
        ...
        (0, env_list_2.outputVariables)(result, flags.outputFormat);
    }
    catch (err) {
        handleError(err);
    }
...
exports.describe = 'Lists all environment variables for a given environment';
